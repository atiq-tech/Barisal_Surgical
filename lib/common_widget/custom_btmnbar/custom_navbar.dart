...
class _BottomNavigationBarViewState
  ...
  Future<void> _initializeData() async {
    ...
    attendanceInStatus =
        sharedPreferences?.getBool('attendanceInStatus');
    attendanceOutStatus =
        sharedPreferences?.getBool('attendanceOutStatus');

    salesEntry =
        '${sharedPreferences?.getString("sales")}';
    customerList =
        '${sharedPreferences?.getString("customerlist")}';
    orderEntry =
        '${sharedPreferences?.getString("order_entry")}';
    ...
    final response = await Dio().post(
      ...
      options: Options(
        headers: {
          ...
          "Cookie":
              "laravel_session=${sharedPreferences.getString('sessionId')}",
        },
      ),
    );
...
//===========OLD CODE (CurvedNavigationBar)===========NEW CODE (BottomNavigationBar)===========
// import 'package:barishal_surgical/screens/modules/administration_module_screens/customer_list_screen.dart';
// import 'package:barishal_surgical/screens/modules/order_module_screens/order_entry_screen.dart';
// import 'package:curved_navigation_bar/curved_navigation_bar.dart';
// import 'package:flutter/material.dart';
